...
//	@Null(message="특기는 반드시 선택해 주셔야 합니다.")
//	@Size(min=2, message="특기는 최소 2개 이상 선택하셔야 합니다.")
//	private String[] special ; //특기(체크 박스이어어 문자열 배열로 정의)	
//	public String[] getSpecial() {	return special;}	
//	public void setSpecial(String[] special) {	this.special = special;}
//	@Override
//	public String toString() {
//		return "Human [MUST_INPUT=" + MUST_INPUT + ", id=" + id + ", name=" + name + ", hobby=" + hobby + ", birth="
//				+ birth + ", job=" + job + ", special=" + Arrays.toString(special) + "]";
//	}		
