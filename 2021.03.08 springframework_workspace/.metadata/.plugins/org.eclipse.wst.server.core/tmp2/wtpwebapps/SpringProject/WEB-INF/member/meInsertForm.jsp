...
<body>
	<div align="center" class="container col-sm-offset-2 col-sm-8">
		<h2>
			<spring:message code="member.register01" />
		</h2>
		<div class="panel panel-primary">
			...
			<div class="panel panel-body">
				...
				<form:form name="myform" modelAttribute="member" action="${apppath}/insert.me" method="post" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input path="id" value="${id}" type="text" id="id" name="id" class="form-control" 
							onkeyup="isCheckFalse();"/>
							<form:errors path="id" cssClass="err"/><!-- err 스타일 태그는 common.jsp 파일에 넣어둠 -->
						</div>
						<div class="col-sm-2" align="left">
							<input type="button" class="btn btn-info" value="<spring:message code="member.duplicatedId" />"
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							...
							<input path="zipcode" value="${zipcode}" type="text" id="fakezipcode" name="fakezipcode" class="form-control" disabled="true"/>
							<input type="hidden" name="zipcode" value="${zipcode}" id="zipcode">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input path="address1" value="${address1}" type="text" id="fakeaddress1" name="fakeaddress1" class="form-control" disabled="true"/>
							<input type="hidden" name="address1" value="${address1}" id="address1">
