...
public class ShapeMain {
	public static void main(String[] args) {
		...
		// Shape 형태의 객체 중에서 객체 이름이 "myCircle"인 항목을 찾아주세요.
		// Shape 부모클래스로 보통 지정함 
		...
		List<Object> lists1 = shape1.GetShapeAll();
		System.out.println("<원의 목록보기>");
		...
		List<Object> lists2 = shape2.GetShapeAll();
		System.out.println("<사각형의 목록보기>");
